...
export class NewTask {
  ...
  render(){
    ...
    const addTaskItemWrapper1 = document.createElement('div');
    addTaskItemWrapper1.className = "add-task-item-wrapper";
    addTaskNew.appendChild(addTaskItemWrapper1);

    const estPomodorosWrapper = document.createElement('div');
    estPomodorosWrapper.className = "est_pomodoros-wrapper";
    addTaskItemWrapper1.appendChild(estPomodorosWrapper);
    ...
    const addTaskItemWrapper2 = document.createElement('div');
    addTaskItemWrapper2.className = "add-task-item-wrapper";
    addTaskNew.appendChild(addTaskItemWrapper2);

    const estPomodorosWrapper2 = document.createElement('div');
    estPomodorosWrapper2.className = "est_pomodoros-wrapper";
    addTaskItemWrapper2.appendChild(estPomodorosWrapper2);
    ...
    const wrapperMb = document.createElement('div');
    wrapperMb.className = "wrapper-mb";
    pomodorosWrapper2.appendChild(wrapperMb);

    const spanPomodoro = document.createElement('span');
    spanPomodoro.className = "span_pomodoro";
    spanPomodoro.innerHTML = 'Est Pomodoros';
    wrapperMb.appendChild(spanPomodoro);
    ...
    const addTaskItemWrapper3 = document.createElement('div');
    addTaskItemWrapper3.className = "add-task-item-wrapper";
    addTaskItemWrapper3.id = "addFeatures";
    addTaskNew.appendChild(addTaskItemWrapper3);

    const div = document.createElement('div');
    addTaskItemWrapper3.appendChild(div);
